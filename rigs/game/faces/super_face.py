...
def create_sample(obj):
    ...
    bone.tail = 0.0693, 0.0221, 0.1103
    bone.roll = 0.0544
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['face']]
    ...
    bone.head = -0.0000, -0.0245, 0.0493
    bone.tail = -0.0000, -0.0406, 0.0567
    bone.roll = -3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['face']]
    ...
    bone.head = -0.0000, -0.0406, 0.0567
    bone.tail = 0.0000, -0.0620, 0.0584
    bone.roll = -3.1416
    bone.use_connect = True
    ...
    bone.head = 0.0000, -0.0620, 0.0584
    bone.tail = 0.0000, -0.0848, 0.0464
    bone.roll = 3.1416
    bone.use_connect = True
