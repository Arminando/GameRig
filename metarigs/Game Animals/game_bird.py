...
def create(obj):
    ...
    arm.rigify_layers[26].name = "Char Root"
    arm.rigify_layers[26].row = 14
    arm.rigify_layers[26].selset = False
    arm.rigify_layers[26].group = 1
    ...
    bone.tail = 0.0000, 0.0462, -0.0000
    bone.roll = 0.0000
    ...
    pbone.bone.layers = [False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, False, False, False, False, False]
    try:
    ...
    arm.layers = [(x in [0, 3, 7, 10, 13, 16, 21, 24, 26]) for x in range(32)]
